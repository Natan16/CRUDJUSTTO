...
public class RegistroOABTest {
	...
	public void testRegistroValido() {
		assertTrue(RegistroOAB.registroValido("1E3456"));//com letra
		assertTrue(RegistroOAB.registroValido("13456"));//sem letra
		
		assertFalse(RegistroOAB.registroValido("-000000")); //não alfanumérico
		...
		assertFalse(RegistroOAB.registroValido("1Z3456"));//letra não válida
	}
